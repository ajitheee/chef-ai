      ...
      <form onSubmit={save} className="w-full max-w-sm rounded-xl border border-line-2 bg-card p-6 shadow-sm">
        ...
        {ready === "ok" && (
          <>
            ...
            <button disabled={busy || !password || !confirm} className="mt-4 w-full rounded-full bg-accent px-4 py-3 text-sm font-bold text-white shadow-sm disabled:opacity-50">
