...
export const NUTRIENTS: NutrientEntry[] = [
  { match: /\bwater\b|\bice\b/i, label: "water", per100g: N(0, 0, 0, 0, 0, 0) },
  { match: /worcestershire/i, label: "Worcestershire", per100g: N(78, 0, 19, 0, 0, 980) },
  { match: /vanilla|almond extract|extract\b/i, label: "extract", per100g: N(288, 0, 13, 0, 0, 9) },
  { match: /dextrose|glucose|corn syrup|invert/i, label: "glucose / dextrose", per100g: N(380, 0, 95, 0, 0, 5) },
  { match: /capers?/i, label: "capers", per100g: N(23, 2.4, 4.9, 0.9, 3.2, 2960) },
  { match: /pickle|gherkin/i, label: "pickles", per100g: N(11, 0.3, 2.3, 0.2, 1.2, 800) },
  { match: /\bolives?\b(?!\s*(oil|blend))/i, label: "olives", per100g: N(115, 0.8, 6, 11, 3.2, 735) },
  { match: /nori|kelp|seaweed|kombu|wakame|dulse/i, label: "seaweed", per100g: N(35, 6, 5, 0.3, 0.3, 87) },
  { match: /\b(rum|brandy|whiske?y|vodka|tequila|liqueur|bourbon|cognac|gin)\b/i, label: "spirits", per100g: N(231, 0, 0, 0, 0, 1) },
  { match: /baking (powder|soda)|bicarbonate/i, label: "leavening", per100g: N(53, 0, 28, 0, 0, 8000) },
  { match: /dried (apricot|cranberr|cherr|fig|date|raisin|fruit)|raisins?|sultanas?|prunes?/i, label: "dried fruit", per100g: N(300, 3, 75, 0.5, 7, 10) },
  { match: /asparagus|artichoke/i, label: "asparagus / artichoke", per100g: N(20, 2.2, 3.9, 0.1, 2.1, 2) },
  { match: /bamboo shoot|water chestnut|bean sprout/i, label: "bamboo shoots / sprouts", per100g: N(27, 2.6, 5.2, 0.3, 2.2, 4) },
  { match: /achiote|annatto|harissa|gochujang|curry paste|chipotle in adobo|adobo sauce/i, label: "spice paste", per100g: N(120, 3, 20, 3, 4, 900) },
  { match: /fenugreek|kasoori|methi/i, label: "fenugreek leaves", per100g: N(323, 23, 58, 6, 25, 67) },
  { match: /ginger/i, label: "fresh ginger", per100g: N(80, 1.8, 18, 0.8, 2, 13) },
  { match: /lemongrass/i, label: "lemongrass", per100g: N(99, 1.8, 25, 0.5, 0, 6) },
  { match: /hominy/i, label: "hominy", per100g: N(72, 1.5, 14, 0.9, 2.5, 345) },
  { match: /tomatillo/i, label: "tomatillo", per100g: N(32, 1, 5.8, 1, 1.9, 1) },
  { match: /radish|daikon/i, label: "radish", per100g: N(16, 0.7, 3.4, 0.1, 1.6, 39) },
  { match: /\bpeas?\b|edamame/i, label: "peas", per100g: N(81, 5.4, 14, 0.4, 5.7, 5) },
  { match: /coconut flakes|shredded coconut|desiccated/i, label: "shredded coconut", per100g: N(354, 3.3, 15, 33, 9, 20) },
  { match: /cheddar|monterey|jack\b|gouda|swiss|gruy|provolone|pepper jack|colby|cotija|queso/i, label: "hard / semi-hard cheese", per100g: N(400, 24, 1.5, 33, 0, 650) },
  { match: /ricotta|cottage/i, label: "ricotta", per100g: N(174, 11, 3, 13, 0, 84) },
  ...
  // cooked-product lines (a card that says "cooked rice" means cooked weight, not dry)
  { match: /cooked\s+(white\s+|brown\s+|jasmine\s+|basmati\s+|long[- ]grain\s+)?rice|steamed rice|rice,\s*cooked/i, label: "rice, cooked", per100g: N(130, 2.7, 28, 0.3, 0.4, 1) },
  { match: /cooked\s+(pasta|noodles?|spaghetti|penne|macaroni)|pasta,\s*cooked/i, label: "pasta, cooked", per100g: N(131, 5, 25, 1.1, 1.8, 1) },
  { match: /cooked\s+(quinoa|couscous|farro|barley|bulgur)/i, label: "grain, cooked", per100g: N(120, 4.4, 21, 1.9, 2.8, 7) },
  ...
  { match: /pineapple|mango|banana|apple|berr|pear|peach|plum|grape|cherr|melon|\bfigs?\b|\bdates?\b|kiwi|papaya/i, label: "fruit", per100g: N(60, 0.7, 15, 0.3, 2, 1) },
  ...
  { match: /cumin|coriander|paprika|oregano|black pepper|white pepper|cayenne|cinnamon|turmeric|thyme|rosemary|bay|clove|nutmeg|allspice|amchur|sumac|za'?atar|fennel|cardamom|star anise|mustard seed|caraway|pepper flake|spice|seasoning|pepper/i, label: "dried spice", per100g: N(330, 13, 50, 15, 25, 80) },
